...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
  ...
  //point cloud processor
   ProcessPointClouds<pcl::PointXYZ> pointProcessor;//= new ProcessPointClouds;
    std::pair<pcl::PointCloud<pcl::PointXYZ>::Ptr,pcl::PointCloud<pcl::PointXYZ>::Ptr> segmentCloud=pointProcessor.SegmentPlane(inputCloud,100,0.2);  

  //renderRays(viewer,lidar->position,inputCloud);
     Color cloudColor(1,0,0);
   //  renderPointCloud(viewer,segmentCloud.first,"obstacle_Cloud",cloudColor);
    // renderPointCloud(viewer,segmentCloud.second,"plance_Cloud",Color(0,1,0));
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
  ...
  // ----------------------------------------------------
    ...
    //enderPointCloud(viewer,filterCloud,"filterCloud");
...
int main (int argc, char** argv)
{
   ...
   // simpleHighway(viewer);
    ...
    std::vector<boost::filesystem::path> stream = pointProcessorI->streamPcd("/home/mohamed/Desktop/Sensor_fusion_ND/SFND_Lidar_Obstacle_Detection/src/sensors/data/pcd/data_1");
